...
class Blood:
    ...
    def menu(self):
        ...
        if ans in ["1", "01"]:
            ...
            print("- Hrcx Nuker is a open sourced nuker which has been developed by simpikaze for hate vector.\n-  Press any key to return.")
            input("")
            self.menu()
        
        elif ans == "12":
            print("{}({}CR{}) Thanks for using Hrcx nuker!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            time.sleep(1.5)
            os._exit(0)
...
if __name__ == "__main__":
    try:
        os.system("title Hrcx Nuker ^| Authentication & mode con: cols=95 lines=25")
